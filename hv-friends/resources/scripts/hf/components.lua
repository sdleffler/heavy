...
do
    ...
    function Position:has_position() return has_position(self) end
...
do
    ...
    function Velocity:has_velocity() return has_velocity(self) end
...
do
    ...
    local hf_create_sprite_animation_cc = hf_sprite.create_sprite_animation_component_constructor
